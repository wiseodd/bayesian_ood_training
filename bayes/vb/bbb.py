...
class BasicBlock(nn.Module):
    ...
    def __init__(self, in_planes, out_planes, stride, var0=1, dropRate=0.0, estimator='flipout'):
...
class WideResNetBBB(nn.Module):
    ...
    def __init__(self, depth, widen_factor, num_classes, num_channel=3, var0=1, droprate=0, estimator='flipout', feature_extractor=False):
        _check_estimator(estimator)
        super().__init__()
